...
procedure Tfrm1_4.btnBigFontClick(Sender: TObject);
begin
  self.lblFontSize.Font.Size := 12;
end;

procedure Tfrm1_4.btnBlackBackgroundClick(Sender: TObject);
begin
  self.lblBackgroundColor.Color := clBlack;
end;

procedure Tfrm1_4.btnYellowBackgroundClick(Sender: TObject);
begin
  self.lblBackgroundColor.Color := clYellow;
end;

procedure Tfrm1_4.btnBlackFontClick(Sender: TObject);
begin
  self.lblFontColor.Font.Color := clBlack;
end;

procedure Tfrm1_4.btnBlueFontClick(Sender: TObject);
begin
  self.lblFontColor.Font.Color := clBlue;
end;

procedure Tfrm1_4.btnFamilyArialClick(Sender: TObject);
begin
  self.lblFontFamily.Font.Name := 'Arial';
end;

procedure Tfrm1_4.btnFamilyTahomaClick(Sender: TObject);
begin
  self.lblFontFamily.Font.Name := 'Tahoma';
end;

procedure Tfrm1_4.btnFamilyTNRClick(Sender: TObject);
begin
  self.lblFontFamily.Font.Name := 'Times New Roman';
end;

procedure Tfrm1_4.btnNormalFontClick(Sender: TObject);
begin
  self.lblFontSize.Font.Size := 8;
end;

procedure Tfrm1_4.btnSmallFontClick(Sender: TObject);
begin
  self.lblFontSize.Font.Size := 5;
end;

procedure Tfrm1_4.btnWhiteBackgroundClick(Sender: TObject);
begin
  self.lblBackgroundColor.Color := clWhite;
end;

procedure Tfrm1_4.btnWhiteFontClick(Sender: TObject);
begin
