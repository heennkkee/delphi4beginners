...
procedure Tfrm2_3.btnGreenClick(Sender: TObject);
begin
  togglAll('green');
end;

procedure Tfrm2_3.btnOrangeClick(Sender: TObject);
begin
  togglAll('orange');
end;

procedure Tfrm2_3.btnRedClick(Sender: TObject);
begin
  togglAll('red');
end;


procedure Tfrm2_3.togglAll(enable: string);
begin
